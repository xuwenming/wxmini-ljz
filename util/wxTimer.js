var wxTimer = function (initObj){
  ...
  this.fields = initObj.fields || "minute";
...
wxTimer.prototype = {
	...
	start:function(self){
	    ...
	    function begin(){
	        ...
	        var tmpTimeStr = tmpTime.toString();//去掉前面的年月日就剩时分秒了
          if (that.fields == 'minute') tmpTimeStr = tmpTimeStr.substr(19, 5);
          else if (that.fields == 'hour') tmpTimeStr = tmpTimeStr.substr(16, 8);
